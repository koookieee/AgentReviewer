...
This is one of your most important phases. Use the search-papers skill (defined in `.claude/skills/search-papers/`) extensively — run at least 10-15 searches covering:
