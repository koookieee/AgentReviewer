...
This is one of your important phase. Use the skill defined in`examples/train_integrations/harbor/search-paper/SKILL.md` extensively — run at least 10-15 searches covering:
